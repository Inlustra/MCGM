...
/**
 * <p>Title: Client HTTP Request class</p> <p>Description: this class helps to
 * send POST HTTP requests with various form data, including files. Cookies can
 * be added to be included in the request.</p>
 *
